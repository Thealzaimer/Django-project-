...
* **`mcp_server.py`:** The Native Bridge. Connects directly to desktop AIs (like Claude Desktop) using FastMCP's `stdio` protocol natively while mirroring the exact same security and logging rules as the web bouncer.
